...
Public rsSplakuk As New recordset
...
Public mblnDaftarPasienLab As Boolean
Public strNFilter As String
Public mstrKodePelayananRS As String

Public substrKdPegawai As String
Public substrNoOrder As String
Public bolStatusFIFO As String
Public IntUmurPasien As Integer
...
Public sStatusOpname As Boolean
